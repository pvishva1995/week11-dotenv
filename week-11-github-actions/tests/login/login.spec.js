...
test.describe(() => {
  ...
  test('should login with existing admin account', async ({ page }) => {
  ...
  test('should logout', async ({ page, request }) => {
    const loginPage = new LoginPage(page);
    const dashboardPage = new DashboardPage(page);

    const apiToken = await apiLogin(request, adminEmail, adminPassword);
