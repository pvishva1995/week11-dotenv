...
test.describe("Search on FeaturedListings page", () => {
    ...
    test.beforeAll(async ({ authenticatedPage }, testInfo) => {
        await authenticatedPage.goto(testInfo.project.use.env.baseUrl, { waitUntil: 'load',timeout: 10000});
    });

    test.beforeEach(async ({ authenticatedPage }) => {
        await authenticatedPage.goto("/featured-listings", { waitUntil: 'load', timeout: 60000 });
